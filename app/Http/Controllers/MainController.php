...
class MainController extends Controller
{
    ...
    /**
     * Saves a RoleUser for the given user_id with the specified role name
     * @param int $user_id The ID of the user
     * @param string $role_name The name of the role (default: USER)
     * @return void
     */
    public function saveRoleUser($user_id, $role_name = null)
    {
        $role_name = $role_name ?? RoleName::USER;
