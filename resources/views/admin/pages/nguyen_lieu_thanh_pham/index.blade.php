            ...
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    @php
                        ...
                        $__ru5 = RoleUser::where('user_id', auth()->id())->first();
                        $__rl5 = $__ru5 ? Role::find($__ru5->role_id) : null;
                        $__isSX = $__rl5 && $__rl5->name === RoleName::NHAN_VIEN_SX;
                    @endphp
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <table class="table datatable_wrapper table-hover vw-100">
                            ...
                            @foreach($datas as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.phieu.san.xuat.detail', $data->nguyenLieuSanXuat->PhieuSanXuat->id) }}">{{ $data->nguyenLieuSanXuat->PhieuSanXuat->so_lo_san_xuat }}</a>
                                    </td>
