    ...
    <section class="section">
                    ...
                    <form method="post" action="{{ route('admin.ban.hang.store') }}" class="" id="form_submit_order">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <div class="form-group col-md-12">
                                    <label for="created_at">Ngày bán hàng</label>
                                    <input type="date" class="form-control" id="created_at"
                                           name="created_at" value="{{ old('created_at', \Carbon\Carbon::now()->format('Y-m-d')) }}">
                                </div>
        ...
        <script>
            ...
            function change_gia_san_pham_temp(el) {
                ...
                totalEl.val((gia_ * so_luong - total_giam_gia).toFixed(0));
            }
            ...
            function change_gia_san_pham(el) {
                ...
                totalEl.val((gia_ * so_luong - giam_gia).toFixed(0));
